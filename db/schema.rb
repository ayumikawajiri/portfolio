...
ActiveRecord::Schema.define(version: 20171123103037) do
  ...
  create_table "classifieds", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_classifieds_on_city_id"
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["classified_id"], name: "index_contacts_on_classified_id"
  end
