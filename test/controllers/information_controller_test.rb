...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { category: @information.category, content: @information.content, title: @information.title, user_id: @information.user_id } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { category: @information.category, content: @information.content, title: @information.title, user_id: @information.user_id } }
