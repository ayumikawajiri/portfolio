...
class ClassifiedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classified" do
    assert_difference('Classified.count') do
      post classifieds_url, params: { classified: { category: @classified.category, city_id: @classified.city_id, content: @classified.content, title: @classified.title, type: @classified.type, user_id: @classified.user_id } }
    end
  ...
  test "should update classified" do
    patch classified_url(@classified), params: { classified: { category: @classified.category, city_id: @classified.city_id, content: @classified.content, title: @classified.title, type: @classified.type, user_id: @classified.user_id } }
